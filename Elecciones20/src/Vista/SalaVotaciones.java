...
public class SalaVotaciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imagenPartidoPolitico.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(239, 243, 245), 1, true));
        ...
        panelPeque.add(imagenPartidoPolitico, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 99, 71));
        ...
        botonVotar.setBackground(new java.awt.Color(240, 147, 43));
        botonVotar.setFont(new java.awt.Font("Open Sans", 0, 14)); // NOI18N
        botonVotar.setForeground(new java.awt.Color(255, 255, 255));
        botonVotar.setText("Buscar");
        panelPeque.add(botonVotar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 30, 100, 30));
        ...
        panelPeque.add(Candidato1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 120, -1, 30));
        ...
        listaCandidatos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        panelbig.add(nacionalidad2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 130, -1, 30));
        ...
        panelbig.add(campoPartido1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 130, 200, 30));
        ...
        panelbig.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(323, 21, 1, 250));
        ...
        panelbig.add(genero2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, -1, 30));
        ...
        panelbig.add(nacionalidad3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 80, -1, 30));
        ...
        panelbig.add(campoNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 210, 30));
        ...
        panelbig.add(campoNacionalidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 220, 30));
        ...
        panelbig.add(scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 180, 330, 90));
        ...
        NombreUsuario.setFont(new java.awt.Font("Open Sans Light", 0, 15)); // NOI18N
        NombreUsuario.setForeground(new java.awt.Color(239, 243, 245));
        NombreUsuario.setText("Texto");
        PanelUsuario.add(NombreUsuario);
        NombreUsuario.setBounds(120, 0, 230, 50);
        ...
        PanelInferior.add(PanelUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 350, 50));
