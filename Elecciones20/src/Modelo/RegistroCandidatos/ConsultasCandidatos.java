...
public class ConsultasCandidatos extends Conexion{
   ...
   consulta.setString(1, presidente.getNombre());
    ...
    try{
     ...
     consulta =  conexion.prepareStatement("SELECT count(idPartido) from alcaldes where id_municipio = ?");//aca me doy cuenta si el numero de identidad se repite entonces ya voto
     consulta.setInt(1, alcalde.getId_Municipio());
